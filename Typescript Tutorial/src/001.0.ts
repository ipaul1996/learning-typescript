...
// any (super type) --> the any type is a special type that can represent values of any data type.
// It is a way to opt out of the static type checking that TypeScript provides. When a variable is
// declared with the any type, it means that TypeScript will not enforce type checking on that variable,
// allowing you to assign values of any type to it.
