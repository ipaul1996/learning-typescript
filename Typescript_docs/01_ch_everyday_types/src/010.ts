...
const reqObjV2 = { url: "https://example.com", method: "GET" as "GET" }; // Change1
makeApiCall(reqObjV2.url, reqObjV2.method as "GET"); // Change2
...
const reqObjV3 = { url: "https://example.com", method: "GET" } as const;
